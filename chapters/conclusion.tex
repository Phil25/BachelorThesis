...
The Updater plugin overviewed in Section~\ref{updater-plugin}, can use a text file provided on the web to automatically update other plugins which support it.
