...
For the initial set up, a GET request is performed to the website pointed to by the \verb|--db-url| flag, defaulting to \url{https://smamdb.net/} if unspecified.
In this request, a variable named \verb|ids| is present, consisting of comma separated list of addon IDs which were provided by the user.
...
Before it may begin, however, the \verb|.smamdata.json| file is parsed, providing information on currently installed addons.
